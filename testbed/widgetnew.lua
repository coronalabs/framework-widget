...
local skinBase = defaultBase				--> default base directory for interface-related resource look-up
local skinPackage = "widget_ios"	--> until .cpk is ready, will be read as such: skinBase .. skinPackage .. "/" .. "resourceFile.png" (example)
local skinSetting = iosSkin				--> defaults to iOS-style widgets

widget.skinBase = skinBase
widget.skinPackage = skinPackage
widget.skinSetting = skinSetting
...
local setSkin = function( interfaceLib )
...
local newEmbossedText = function( text, xPos, yPos, font, size, fontColor, isCategory, offset )
...
widget.newEmbossedText = newEmbossedText
...
local newRoundedRectButton = function( params )
...
widget.newRoundedRectButton = newRoundedRectButton
...
local newButton = function( params )
...
local newSegmentedControl = function( buttonTable, params )
...
local newSlider = function( params )
...
local function newTableView( params )
...
local function newPickerWheel( params )
